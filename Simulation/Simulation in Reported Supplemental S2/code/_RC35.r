...
for(i in 1:2){
  write.csv(data[[i]], file=paste0(wd.d.mac,'MACond', 35,'_M',i, '.csv'))
}
...
write.csv(Res1, file=paste0(wd.r.mac,'MMAresCond', 35,'_M',1, '.csv'))
...
write.csv(Res2, file=paste0(wd.r.mac,'MMAresCond', 35,'_M',2, '.csv'))
